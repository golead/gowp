const paramsToObject=e=>{const t={};for(var[n,o]of e)t[n]=o;return t},closeBoxGowp=()=>{let e=document.getElementById("box-gowp");e.style.display="none"},handleSendGowp=async()=>{document.getElementById("text-not-loading-wp").style.display="none",document.getElementById("text-loading-wp").style.display="block";let e=document.getElementById("gowpchat");var t=e.getAttribute("src");let n=new URL(t);var o=paramsToObject(n.searchParams.entries()),t={from:"gowhatsapp",cd_user:o.cd_user,ref_channel:o.ref_channel,nome:document.getElementById("name-input-gowp").value,email:document.getElementById("email-input-gowp").value,telefone:document.getElementById("phone-input-gowp").value,observacao:"Mensagem envia no WhatsApp"};try{await fetch("https://kze0xastg5.execute-api.us-east-1.amazonaws.com/prod/send-lead-whatsapp",{method:"POST",mode:"cors",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}).then(e=>e.json());let e=document.getElementById("text-error-wp");e.style.display="none",document.getElementById("text-not-loading-wp").style.display="block",document.getElementById("text-loading-wp").style.display="none",window.location.href=`https://api.whatsapp.com/send?phone=${o.cd_wp}&text=Olá, vamos conversar?`}catch(e){console.log(e),document.getElementById("text-not-loading-wp").style.display="block",document.getElementById("text-loading-wp").style.display="none",document.getElementById("text-error-wp").style.display="block"}},loadButton=()=>{let e=document.createElement("div");e.setAttribute("id","golead-wpp");let t=document.createElement("button"),n=document.createElement("div");t.setAttribute("id","btn-gowpp"),t.innerHTML=`<div>
